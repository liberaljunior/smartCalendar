...
public class taskDB extends SQLiteOpenHelper {
    Context ctx;
    SQLiteDatabase db;
    static String DB_NAME = "TASK_DB";
    static String TABLE_NAME = "NAME_TABLE";
    static int VERSION = 1;

    taskDB(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
...
//        qu = "select TITLE, (HOURS/(DUE_DATE - "+ date +" + 1)) from " +
//                TABLE_NAME +" where DUE_DATE > " + date + " AND DUE_DATE <=" +
//                " "+ date + " + 7 " + " AND HOURS > 0 AND "+ date+ " >=startDate ORDER BY
//                HOURS DESC, DUE_DATE DESC";
//        Cursor cu = db.rawQuery(qu, null);
//        count = 0;
//        while(cu.moveToNext()){
//            String next = "Task: " + cu.getString(0) + " --- Time: " +
